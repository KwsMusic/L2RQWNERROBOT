...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/II_ASHISH_GUPTA_IIl) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
        ...
        if name[0:3] == "inf":
            m = await message.reply_text("📡 ʙʏ ⋆» ᴀsʜɪsʜ✨🇮🇳🕊️")
...
**💞🌹Asʜɪsʜ ɪ ʟᴏᴠᴇ ʏᴏᴜ sᴏ ᴍᴜᴄʜ🌹💞**

|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [Asʜɪsʜ❣️](https://t.me/II_ASHISH_GUPTA_IIl) 🥀 ||
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🍒̵̶⃰͟˶֟፝͟͝sᴜᴩᴩᴏʀᴛ⏎͟🝛꯭•", url="https://t.me/II_ASHISH_GUPTA_IIl"
                        ),
                    ],
                ]
            )
